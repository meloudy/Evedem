      ...
      <div className='d-flex flex-column position-absolute'>
        ...
        <div className='card1 d-flex flex-row'>
          ...
          <div className="texts d-flex flex-column">
            ...
            <button className="btn" onClick={() => navigate('/categories/0')}>Discover Now</button>
          </div>
        </div>
      </div>
      ...
      <div className='right-catg d-flex flex-column position-absolute'>
        ...
        <div className='card1 d-flex flex-row'>
          ...
          <div className="texts d-flex flex-column">
            ...
            <button className="btn" onClick={() => navigate('/categories/1')}>Discover Now</button>
          </div>
        </div>
      </div>
      ...
      <div className='d-flex flex-column position-absolute'>
        ...
        <div className='card1 d-flex flex-row'>
          ...
          <div className="texts d-flex flex-column">
            ...
            <button className="btn" onClick={() => navigate('/categories/2')}>Discover Now</button>
          </div>
        </div>
      </div>
      ...
      <div className='right-catg d-flex flex-column position-absolute'>
        ...
        <div className='card1 d-flex flex-row'>
          ...
          <div className="texts d-flex flex-column">
            ...
            <button className="btn" onClick={() => navigate('/categories/3')}>Discover Now</button>
          </div>
        </div>
      </div>
    </div>
